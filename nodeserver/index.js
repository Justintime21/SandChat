...
io.on('connection', socket =>{
    // if we get a user-joined event then the user socket id is given to the name. this is done so that when people of the same name join there is no confusion since there socket id will be different
    ...
    // when the send/recieve event is done then run this function
